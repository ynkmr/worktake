...
<html>
  <head>
    ...
    <title>My JSP 'subdic.jsp' starting page</title>
    	...
    	<div class="form-group">
			<table id="tg" class="easyui-treegrid"
			            data-options="iconCls: 'icon-ok',
			                ...
			                collapsible: true,
			                fitColumns: true,
			                url: '/WorkTakeService/dictionary/allsub.do',
			                method: 'get',
			                idField: 'id',
			                treeField: 'name',
			                singleSelect: false,
    ...
    <div id="w" class="easyui-window" title="编辑项目" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:350px;height:300px;padding:10px;">
		<form role="form" id="fm" method="post">
			<div class="form-group">
				...
				<label for="parent_id">父项目类型：</label>
				<input class="easyui-combotree" id="id_parent_id" name="parent_id">
